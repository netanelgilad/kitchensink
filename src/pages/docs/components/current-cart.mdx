...
- `variantInfo: Array<{ name: string; value: string; colorCode?: string }>` - Variant information (e.g., size, color)
- `hasVariants: boolean` - Whether this item has variant selections
