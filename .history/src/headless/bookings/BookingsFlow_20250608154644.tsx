...
import { BookingsServiceDefinition, BookingStatus, BookingErrorCode } from "./bookings-service";
import { CheckoutServiceDefinition, CheckoutStatus, CheckoutErrorCode } from "./checkout-service";
...
const ServicesList = (props: ServicesListProps) => {
  ...
  const isLoading = state.status === BookingStatus.LOADING_SERVICES;
